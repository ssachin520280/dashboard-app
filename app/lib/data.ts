...
//     const testConnection = await client.sql`SELECT 1 as test`;
...
//       fullError: error
//     });
//     throw new Error('Failed to fetch revenue data. Check server logs for details.');
//   }
// }
